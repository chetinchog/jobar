...
func (p *RemoteOK) GetName() string { return "RemoteOK" }
func (p *RemoteOK) GetMaxJobs() int { return p.MaxJobs }

func (p *RemoteOK) FetchJobs(isDuplicate func(models.Item) bool, process func(models.Item)) error {
	count := 0
